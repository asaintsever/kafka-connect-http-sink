...
public class HttpSinkConnectorConfig extends AbstractConfig {
    ...
    public static ConfigDef configDef(Map<?, ?> originals) {
        ConfigDef connectorConfigDef = new ConfigDef()
                ...
                .define(HTTP_REQ_CONTENT_TYPE_CONFIG, Type.STRING, HTTP_REQ_CONTENT_TYPE_DEFAULT, Importance.MEDIUM, HTTP_REQ_CONTENT_TYPE_DOC, HTTP_GROUP, 5, Width.MEDIUM, HTTP_REQ_CONTENT_TYPE_DISPLAYNAME)
                .define(HTTP_REQ_AUTHENTICATION_PROVIDER_CLASS_CONFIG, Type.STRING, HTTP_REQ_AUTHENTICATION_PROVIDER_CLASS_DEFAULT, new ClassValidator(IAuthenticationProvider.class), Importance.MEDIUM, HTTP_REQ_AUTHENTICATION_PROVIDER_CLASS_DOC, HTTP_GROUP, 6, Width.MEDIUM, HTTP_REQ_AUTHENTICATION_PROVIDER_CLASS_DISPLAYNAME)
                .define(HTTP_RESP_VALID_STATUS_CODES_CONFIG, Type.LIST, HTTP_RESP_VALID_STATUS_CODES_DEFAULT, Importance.HIGH, HTTP_RESP_VALID_STATUS_CODES_DOC, HTTP_GROUP, 4, Width.SHORT, HTTP_RESP_VALID_STATUS_CODES_DISPLAYNAME)
                // Retries group
                ...
                .define(HTTP_REQ_RETRY_EXPBACKOFF_MULTIPLIER_CONFIG, Type.DOUBLE, HTTP_REQ_RETRY_EXPBACKOFF_MULTIPLIER_DEFAULT, Importance.MEDIUM, HTTP_REQ_RETRY_EXPBACKOFF_MULTIPLIER_DOC, RETRIES_GROUP, 0, Width.SHORT, HTTP_REQ_RETRY_EXPBACKOFF_MULTIPLIER_DISPLAYNAME)
